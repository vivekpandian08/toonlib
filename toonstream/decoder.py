...
class ToonDecoder:
    ...
    def _parse_tabular(self, toon_str: str) -> Any:
        ...
        if len(objects) != count:
            raise ToonDecodeError(f"Expected {count} rows but got {len(objects)}")
