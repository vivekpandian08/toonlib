...
import toonstream
from toonstream import ToonDecodeError, ToonEncodeError, decode, encode
...
class TestObjects(unittest.TestCase):
    ...
    def test_object_with_array(self):
        ...
        obj = {"name": "John", "hobbies": ["reading", "gaming", "coding"]}
        encoded = encode(obj, indent=0)
        decoded = decode(encoded)
        self.assertEqual(decoded, obj)
            ...
            "config": {
                "database": {
                    "connections": [
                        ...
                        {"host": "replica.example.com", "port": 5433, "ssl": False},
                    ]
                },
